"""Deterministic direction tables that drive each ghost's scripted movement.

Each entry is [dx, dy, step_count] -- see Ghost.changespeed / advance_ghost_meta
for how they're walked through.
"""

Pinky_directions = [
    [0, -30, 4], [15, 0, 9], [0, 15, 11], [-15, 0, 23], [0, 15, 7],
    [15, 0, 3], [0, -15, 3], [15, 0, 19], [0, 15, 3], [15, 0, 3],
    [0, 15, 3], [15, 0, 3], [0, -15, 15], [-15, 0, 7], [0, 15, 3],
    [-15, 0, 19], [0, -15, 11], [15, 0, 9],
]
Blinky_directions = [
    [0, -15, 4], [15, 0, 9], [0, 15, 11], [15, 0, 3], [0, 15, 7],
...
Inky_directions = [
    [30, 0, 2], [0, -15, 4], [15, 0, 10], [0, 15, 7], [15, 0, 3],
...
Clyde_directions = [
    [-30, 0, 2], [0, -15, 4], [15, 0, 5], [0, 15, 7], [-15, 0, 11],
